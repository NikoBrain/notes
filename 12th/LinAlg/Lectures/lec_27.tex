...
\begin{note}
    Row-equivalent matrices have the same row space. This follows from the fact that elementary row operations produce linear combinations of the original rows.
\end{note}
