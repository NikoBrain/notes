...
\declaretheorem[style=thmredbox, name=Theorem, sibling=definition]{theorem}
\declaretheorem[style=thmred2box, name=Theorem, numbered=no]{theorem*}
\declaretheorem[style=thmpinkbox, name=Lemma, sibling=definition]{lemma}
\declaretheorem[style=thmblue2box, name=Result, sibling=definition]{result}
\declaretheorem[style=thmgreen2box, name=Conclusion, sibling=definition]{conclusion}
\declaretheorem[style=thmgreen2box, name=Conclusion, numbered=no]{conclusion*}
\declaretheorem[style=thmredbox, name=Proposition, sibling=definition]{proposition}
\declaretheorem[style=thmredbox, name=Corollary, sibling=definition]{corollary}
...
\renewenvironment{proof}[1][\proofname]{\par
	...
	\trivlist
	\item[\hskip\labelsep
	            \color{NavyBlue!70!black}\sffamily\bfseries
	            #1\@addpunct{.}]\ignorespaces
	\begin{mdframed}[linewidth=2pt,rightline=false, topline=false, bottomline=false,linecolor=NavyBlue, backgroundcolor=\ifthmbackground WildStrawberry!1 \else White!1 \fi]
		}{%
